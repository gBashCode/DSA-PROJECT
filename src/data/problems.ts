...
export const problems: Problem[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  // 2. Two Pointers (Easy → Medium → Hard)
  // ═══════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════
  // 3. Sliding Window (Easy → Medium → Hard)
  // ═══════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════
  // 5. Binary Search (Easy → Medium → Hard)
  // ═══════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════
  // 6. Linked List (Easy → Medium → Hard)
  // ═══════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════
  // 12. 1D Dynamic Programming (Easy → Medium)
  // ═══════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════
  // 13. 2D Dynamic Programming (Medium)
  // ═══════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════
  // 17. Bit Manipulation (Easy → Medium)
  // ═══════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════
  // 21. Advanced Patterns (Medium → Hard)
  // ═══════════════════════════════════════════════════════════════
